...
export const ARDUINO_UNO_PIN = [
    ...
    { name: 'GND3', x: 115.5, y: 9, dir: "top", signals: [{ type: 'power', signal: 'GND' }] },
    ...
    { name: 'GND1', x: 169.5, y: 191.5, dir: "bottom", signals: [{ type: 'power', signal: 'GND' }] },
    { name: 'GND2', x: 179, y: 191.5, dir: "bottom", signals: [{ type: 'power', signal: 'GND' }] },
